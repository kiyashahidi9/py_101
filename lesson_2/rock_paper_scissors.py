...
def return_choices_list(choice_list):
    display_list = []
...
def shortened_choices(choice_list):
    shortened_list = []
...
def player_won(player, computer):
    if ((player == 'rock' and (computer in 
                                ['scissors', 'lizard'])) or
...
# more variables
display_choices = return_choices_list(VALID_CHOICES)
valid_shortened_choices = shortened_choices(VALID_CHOICES)
